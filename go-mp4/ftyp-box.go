...
var (
	isom [4]byte = [4]byte{'i', 's', 'o', 'm'}
	iso2 [4]byte = [4]byte{'i', 's', 'o', '2'}
	iso3 [4]byte = [4]byte{'i', 's', 'o', '3'}
	iso4 [4]byte = [4]byte{'i', 's', 'o', '4'}
	iso5 [4]byte = [4]byte{'i', 's', 'o', '5'}
	iso6 [4]byte = [4]byte{'i', 's', 'o', '6'}
	avc1 [4]byte = [4]byte{'a', 'v', 'c', '1'}
	mp41 [4]byte = [4]byte{'m', 'p', '4', '1'}
	mp42 [4]byte = [4]byte{'m', 'p', '4', '2'}
	dash [4]byte = [4]byte{'d', 'a', 's', 'h'}
	msdh [4]byte = [4]byte{'m', 's', 'd', 'h'}
	msix [4]byte = [4]byte{'m', 's', 'i', 'x'}
)
