...
var (
	vide HandlerType = HandlerType{'v', 'i', 'd', 'e'}
	soun HandlerType = HandlerType{'s', 'o', 'u', 'n'}
	hint HandlerType = HandlerType{'h', 'i', 'n', 't'}
	meta HandlerType = HandlerType{'m', 'e', 't', 'a'}
	auxv HandlerType = HandlerType{'a', 'u', 'x', 'v'}
)
